...
//public class GameApplication implements CommandLineRunner {
    ...
    //            questionService.createQuestion(questionName, Integer.parseInt(type), Integer.parseInt(level), directory, fileName, "png", Boolean.parseBoolean(isLetter), firstLetter.charAt(0));
    //        }
    //
    //
