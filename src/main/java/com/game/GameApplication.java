...
public class GameApplication implements CommandLineRunner {
    ...
    public void createUsers() {
        try {
            System.out.println("creating schools");
            schoolService.createSchool("Besti skólinn");
            schoolService.createSchool("Versti skólinn");

            System.out.println("creating supervisors");
            schoolService.createSupervisor("supervisor", "supervisor", 1L);
            schoolService.createSupervisor("supervisor2", "supervisor2", 2L);

            System.out.println("creating children");
            schoolService.createSchoolChild("Sæti strákurinn",1L);
            schoolService.createSchoolChild("Lísa lesgáfaða",1L);
            schoolService.createSchoolChild("Brjánn bandbrjálaði",2L);
            schoolService.createSchoolChild("Ljótikrakki",2L);

            System.out.println("creating admins");
            schoolService.createSchoolAdmin("admin", "admin", 1L);
            schoolService.createSchoolAdmin("admin2", "admin2", 2L);

            System.out.println("adding children to admins");
            adminService.addChildToAdmin(3L, 1L);
            adminService.addChildToAdmin(3L, 2L);

            adminService.addChildToAdmin(4L, 3L);
            adminService.addChildToAdmin(4L, 4L);
        } catch (Exception e) {
    ...
    public void createQuestion(){
        try {
            ...
            List<String[]> data = Arrays.asList(
                    ...
                    new String[]{"Ellefu", "2", "tolur", "numer_11","false", "e", "2"},
